var lang = {
	...
	uk: {
		...
		hideLocation: 'Ховати розташування',
		transitions: 'Переходи',
		transInterval: 'Проміжок',
		transHint: 'В розділі \'Основні\' Ви можете додати більше одного міста,<br> розділяючи їх крапкою з комою',
		hint: 'Порада',
		iconSet: 'Призначити іконку',
		sec: 'сек.',
		transDuration: 'Тривалість',
		transType: 'Різновид',
		transFunc: 'Призначення',
		other: 'Інші',
		cacheEnabled: 'Використовувати кеш зображень',
		clearCache: 'Очистити кеш',
		clear: 'Очистити',
		resetDefault: 'Скидання за замовчуванням',
		reset: 'Скинути',
		transTypeNone: 'аж ніяк',
		transTypeLeft: 'ліворуч',
		transTypeRight: 'праворуч',
		transTypeOpacity: 'видимість'
	},
	vi: {
		Mon: 'hai',
		Tue: 'ba',
